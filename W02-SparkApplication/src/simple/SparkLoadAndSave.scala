...
object SparkLoadAndSave {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val conf = new SparkConf().setAppName("CLoadingSavingData").setMaster("local[2]") //run with 2 core. i.e. local[2]
    ...
    // Loading CSV
    val input1 = sc.textFile("/home/cloudera/git/S-BEAD/W02-SparkApplication/data/stocks.csv")
